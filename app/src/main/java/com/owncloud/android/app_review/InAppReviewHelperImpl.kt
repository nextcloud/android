...
import com.owncloud.android.utils.getFormattedStringDate
import com.owncloud.android.utils.isCurrentYear
    ...
    override fun showInAppReview(activity: AppCompatActivity) {
        ...
        appReviewShownModel?.let {
            if (it.appRestartCount >= MIN_APP_RESTARTS_REQ &&
                ...
                Log_OC.d(TAG, "Yearly limit reached or minimum app restarts not completed: $appReviewShownModel")
            }
        }
    }
