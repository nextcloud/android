...
public final class FileUtil {
    ...
    public static File saveJpgImage(Bitmap bitmap, File file, int quality) {
        return saveImage(file, bitmap, quality);
    }

    public static File savePngImage(Bitmap bitmap, File file, int quality) {
        return saveImage(file, bitmap, quality);
    }
    ...
    private static File saveImage(File file, Bitmap bitmap, int quality) {
        try {
