...
private const val WIDE_PORTRAIT_COLUMNS = 3
private const val NORMAL_PORTRAIT_COLUMNS = 2

enum class ColumnCount(val landscape: Int, val portrait: Int) {
    Wide(WIDE_LANDSCAPE_COLUMNS, WIDE_PORTRAIT_COLUMNS),
    Normal(NORMAL_LANDSCAPE_COLUMNS, NORMAL_PORTRAIT_COLUMNS);
