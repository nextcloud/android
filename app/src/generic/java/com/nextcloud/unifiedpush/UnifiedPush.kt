...
class UnifiedPush : PushService() {
    companion object {
        ...
        fun registerForPushMessaging(activity: DrawerActivity?, accountName: String, forceChoose: Boolean) {
            ...
            activity.mHandler.post {    // run on ui thread
    ...
    override fun onNewEndpoint(endpoint: PushEndpoint, instance: String) {
        ...
        ArbitraryDataProviderImpl(this).storeOrUpdateKeyValue(instance, PushUtils.KEY_PUSH, Gson().toJson(newAccountPushData))
    }
