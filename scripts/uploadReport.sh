...
curl -u $7:$8 -X POST https://api.github.com/repos/nextcloud/android/issues/$6/comments -d "{ \"body\" : \"$TYPE test failed on Android $ANDROID_VERSION: https://www.kaminsky.me/nc-dev/android-integrationTests/$FOLDER \" }"
