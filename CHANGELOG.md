...
-2017-01-29] added
-Branches: 14] added
- Integration (nextcloud/integration) [https://api.github.com/repos/nextcloud/android/pulls/590] added
- Feature user information (nextcloud/feature-user-information) [https://api.github.com/repos/nextcloud/android/pulls/585] added
- New sorting order dialog (nextcloud/newSortingLayout) [https://api.github.com/repos/nextcloud/android/pulls/575] added
- Search inside of text files (nextcloud/bugfix-454) [https://api.github.com/repos/nextcloud/android/pulls/565] added
- Avoid toggling favourite for all selected files (mario/improvement-toggle-favourite-only-relevant-files) [https://api.github.com/repos/nextcloud/android/pulls/524] added
...
- show SVG images (nextcloud/svgView) [https://api.github.com/repos/nextcloud/android/pulls/465] added
- Fix file modification date on upload (nextcloud/fix_file_modification_date_on_upload) [https://api.github.com/repos/nextcloud/android/pulls/451] added
...
- Updated federated sharing edit options (nextcloud/federated_sharing_edit_options) [https://api.github.com/repos/nextcloud/android/pulls/395] added
- Streaming (nextcloud/streaming) [https://api.github.com/repos/nextcloud/android/pulls/183] added
- Resize cache (nextcloud/resizeCache) [https://api.github.com/repos/nextcloud/android/pulls/144] added
- Instant upload in the context of multi account support (nextcloud/instant_upload_multi_account) [https://api.github.com/repos/nextcloud/android/pulls/98] added
- Resized images (nextcloud/resizedImages) [https://api.github.com/repos/nextcloud/android/pulls/69] added
