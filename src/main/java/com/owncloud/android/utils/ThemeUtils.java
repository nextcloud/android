...
public class ThemeUtils {
    ...
    public static void tintFloatingActionButton(FloatingActionButton button, @DrawableRes int
        ...
        button.setColorNormal(ThemeUtils.primaryColor(context));
        button.setColorPressed(ThemeUtils.primaryDarkColor(context));
        button.setIconDrawable(ThemeUtils.tintDrawable(drawable, ThemeUtils.fontColor(context)));
    }
