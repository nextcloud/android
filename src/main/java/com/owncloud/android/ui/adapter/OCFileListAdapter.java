    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof OCFileListFooterViewHolder) {
            ...
            if (highlightedItem != null && file.getFileId() == highlightedItem.getFileId()) {
                ...
                gridViewHolder.getCheckbox().setImageResource(R.drawable.ic_checkbox_marked);
            ...
            if (holder instanceof ListItemViewHolder) {
                ...
                if ((file.isSharedWithMe() || file.isSharedWithSharee()) && !multiSelect && !gridView &&
                    !hideItemOptions) {
                    itemViewHolder.getSharedAvatars().setVisibility(View.GONE);//visibility gone as view not required
