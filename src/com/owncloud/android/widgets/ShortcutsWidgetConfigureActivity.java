...
public class ShortcutsWidgetConfigureActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.shortcuts_widget_configure);
        ...
        mAppWidgetText.setText(loadTitlePref(ShortcutsWidgetConfigureActivity.this, mAppWidgetId));
    }

    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = ShortcutsWidgetConfigureActivity.this;
